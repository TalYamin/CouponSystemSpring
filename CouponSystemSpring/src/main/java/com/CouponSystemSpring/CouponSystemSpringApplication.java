...
//		companyRepository.save(company);
		...
		/** Admin Service Test**/
		AdminService adminService = applicationContext.getBean(AdminServiceImpl.class);
//		System.out.println(adminService.addCompany(new Company(9999, "Acer", "Acer9999", "info@acer.com")));
//		System.out.println(adminService.removeCompany(9999));
//		System.out.println(adminService.updateCompany(4321, "Asus1234", "info@asus.com"));
//		adminService.getAllCompanies();
//		adminService.getCompany(9876);
//		System.out.println(adminService.addCustomer(new Customer(314, "Tal Yamin", "Tal313")));
//		System.out.println(adminService.addCustomer(new Customer(456, "Ofek Mesika", "Ofek456")));
