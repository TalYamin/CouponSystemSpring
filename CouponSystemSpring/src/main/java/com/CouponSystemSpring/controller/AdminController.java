...
public class AdminController {
	...
	public ResponseEntity<ServiceStatus> addCompany(@RequestBody Company company) throws Exception{
		try {
	...
	public ResponseEntity<ServiceStatus> removeCompany(@PathVariable("companyId") long companyId) throws Exception{
		try {
		...
		if (serviceStatus.isSuccess() == true) {
			...
			throw new AdminControllerException("Admin failed to remove company " + companyId);
		}
		}catch (AdminControllerException e) {
			System.out.println(e.getMessage());
		}catch (Exception e) {
	...
	public ResponseEntity<ServiceStatus> updateCompany(@RequestBody String jsonString) throws Exception{
		try {
		...
		if (serviceStatus.isSuccess() == true) {
			...
			throw new AdminControllerException("Admin failed to update company " + companyId);
		}
		}catch (AdminControllerException e) {
			System.out.println(e.getMessage());
		}catch (Exception e) {
	...
	public ResponseEntity<Company> getCompany(@PathVariable("companyId") long companyId) throws Exception{
		try {
		...
		if (company != null) {
			...
			throw new AdminControllerException("Admin failed to get company " + companyId);
		}
		}catch (AdminControllerException e) {
			System.out.println(e.getMessage());
		}catch (Exception e) {
	...
	public ResponseEntity<ServiceStatus> addCustomer(@RequestBody Customer customer) throws Exception{
		try {
		...
		if (serviceStatus.isSuccess() == true) {
			...
			throw new AdminControllerException("Admin failed to add customer ", customer.getCustomerId(), customer.getCustomerName(), ClientType.CUSTOMER.toString());
		}
		}catch (AdminControllerException e) {
			System.out.println(e.getMessage());
		}catch (Exception e) {
	...
	public ResponseEntity<ServiceStatus> removeCustomer(@PathVariable("customerId") long customerId) throws Exception{
		try {
		...
		if (serviceStatus.isSuccess() == true) {
			...
			throw new AdminControllerException("Admin failed to remove customer " + customerId);
		}
		}catch (AdminControllerException e) {
			System.out.println(e.getMessage());
		}catch (Exception e) {
	...
	public ResponseEntity<ServiceStatus> updateCustomer(@RequestBody String jsonString) throws Exception{
		try {
			JsonParser parser = new JsonParser();
			JsonObject obj = parser.parse(jsonString).getAsJsonObject();
		...
		if (serviceStatus.isSuccess() == true) {
			...
			throw new AdminControllerException("Admin failed to update customer " + customerId);
		}
		}catch (AdminControllerException e) {
			System.out.println(e.getMessage());
		}catch (Exception e) {
	...
	public ResponseEntity<Customer> getCustomer(@PathVariable("customerId") long customerId) throws Exception{
		try {
		...
		if (customer != null) {
			...
			throw new AdminControllerException("Admin failed to get customer " + customerId);
		}
		}catch (AdminControllerException e) {
			System.out.println(e.getMessage());
		}catch (Exception e) {
